...
public class SimpleWeapon extends Item implements Weapon, Breakable {
    ...
    protected static SimpleWeapon createWeapon(SimpleWeaponPreset preset) {
        return new SimpleWeapon(preset.name, preset.damage, preset.missRate, preset.startingIntegrity, preset.startingIntegrity, preset.hitDecrement);
    }

    public SimpleWeapon(String name, int damage, int missRate) {
        this(name, damage, missRate, 100, 100, 1);
    }

    public SimpleWeapon(String name, int damage, int missRate, int maxIntegrity, int curIntegrity, int hitDecrement) {
        super(name, TYPE);
        this.damage = damage;
